...
import { gltfTextureInfo } from "./texture";
...
class gltfMaterial extends GltfObject {
  ...
  private emissiveFactor: vec3;
  private alphaMode: string;
  private alphaCutoff: number;
  private doubleSided: boolean;

  private hasClearcoat: boolean;
  private hasSheen: boolean;
  private hasTransmission: boolean;
  private hasIOR: boolean;
  private hasEmissiveStrength: boolean;
  private hasVolume: boolean;
  private hasIridescence: boolean;
  ...
  private hasSpecular: boolean = false;
  ...
  private iridescenceTexture;
  private iridescenceThicknessTexture;
  ...
  parseTextureInfoExtensions(textureInfo, textureKey) {
    ...
    if (textureInfo.extensions.KHR_texture_transform !== undefined) {
      ...
      if (uvTransform.rotation !== undefined) {
        ...
        rotation = jsToGl([c, -s, 0.0, s, c, 0.0, 0.0, 0.0, 1.0]) as mat3;
      }
  ...
  initGl(gltf, webGlContext) {
    ...
    if (this.extensions !== undefined) {
      ...
      if (this.extensions.KHR_materials_emissive_strength !== undefined) {
        ...
        let emissiveStrength =
          this.extensions.KHR_materials_emissive_strength.emissiveStrength ??
          1.0;
      ...
      if (this.extensions.KHR_materials_iridescence !== undefined) {
        ...
        let factor =
          this.extensions.KHR_materials_iridescence.iridescenceFactor;
        let iridescenceIOR =
          this.extensions.KHR_materials_iridescence.iridescenceIOR;
        let thicknessMinimum =
          this.extensions.KHR_materials_iridescence.iridescenceThicknessMinimum;
        let thicknessMaximum =
          this.extensions.KHR_materials_iridescence.iridescenceThicknessMaximum;
        ...
        if (this.iridescenceTexture !== undefined) {
          ...
          this.properties.set(
            "u_IridescenceUVSet",
            this.iridescenceTexture.texCoord
          );
        }

        if (this.iridescenceThicknessTexture !== undefined) {
          this.iridescenceThicknessTexture.samplerName =
          ...
          this.properties.set(
            ...
            this.iridescenceThicknessTexture.texCoord
          );
  ...
  fromJson(jsonMaterial) {
    ...
    if (jsonMaterial.emissiveFactor !== undefined) {
      this.emissiveFactor = jsToGl(jsonMaterial.emissiveFactor) as vec3;
    }
  ...
  fromJsonMaterialExtensions(jsonExtensions) {
    if (jsonExtensions.KHR_materials_pbrSpecularGlossiness !== undefined) {
      this.type = "SG";
      this.fromJsonSpecularGlossiness(
