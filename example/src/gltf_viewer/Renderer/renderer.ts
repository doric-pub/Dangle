...
import { GltfState } from "../GltfState/gltf_state";
import { gltfWebGl, GL } from "./webgl";
import { EnvironmentRenderer } from "./environment_renderer";
...
import { gltfLight } from "../gltf/light";
...
class gltfRenderer {
  ...
  private visibleLights: any[];

  private viewMatrix: mat4;
  private projMatrix: mat4;
  private viewProjectionMatrix: mat4;

  private currentCameraPosition: vec3;
  private lightKey: gltfLight;
  private lightFill: gltfLight;

  private colorRenderBuffer;
  private depthRenderBuffer;
  private opaqueFramebufferMSAA;

  private environmentRenderer?: EnvironmentRenderer;

  private nodes;
  private opaqueDrawables;
  private transparentDrawables;
  private transmissionDrawables;
  ...
  drawScene(state, scene) {
    ...
    if (this.transmissionDrawables.length > 0) {
      ...
      for (const drawable of this.opaqueDrawables) {
        var renderpassConfiguration = {} as any;
  ...
  pushFragParameterDefines(fragDefines, state) {
    ...
    let debugOutputMapping = [
      ...
      {
        debugOutput: GltfState.DebugOutput.mr.METALLIC_ROUGHNESS,
        shaderDefine: "DEBUG_METALLIC_ROUGHNESS",
      },
      {
      ...
      {
        debugOutput: GltfState.DebugOutput.clearcoat.CLEARCOAT,
        shaderDefine: "DEBUG_CLEARCOAT",
      },
      {
      ...
      {
        debugOutput: GltfState.DebugOutput.sheen.SHEEN,
        shaderDefine: "DEBUG_SHEEN",
      },
      {
      ...
      {
        debugOutput: GltfState.DebugOutput.specular.SPECULAR,
        shaderDefine: "DEBUG_SPECULAR",
      },
      {
      ...
      {
        debugOutput: GltfState.DebugOutput.transmission.TRANSMISSION_VOLUME,
        shaderDefine: "DEBUG_TRANSMISSION_VOLUME",
      },
      {
      ...
      {
        debugOutput: GltfState.DebugOutput.iridescence.IRIDESCENCE,
        shaderDefine: "DEBUG_IRIDESCENCE",
      },
      {
