      ...
      dangleView({
        onReady: async (gl: WebGL2RenderingContext) => {
          ...
          async function init() {
            ...
            const geometry = BufferGeometryUtils.mergeBufferGeometries( geometries ) as any;
            geometry.computeBoundingSphere();

            // const texture = new THREE.TextureLoader().load( 'textures/minecraft/atlas.png' );
            const remoteResource = new RemoteResource('https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/minecraft/atlas.png')
          ...
          function generateHeight( width, height ) {
            ...
            const data: any[] = [], perlin = new ImprovedNoise(),
