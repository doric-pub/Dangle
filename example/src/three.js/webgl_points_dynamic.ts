        ...
        [
          dangleView({
            onReady: async (gl: WebGL2RenderingContext) => {
              ...
              const meshes: any[] = [], clonemeshes: any[] = [];
              ...
              async function init() {
                ...
                {
                  const resource = new RemoteResource('https://raw.githubusercontent.com/mrdoob/three.js/master/examples/models/obj/female02/female02.obj')
                  const arrayBuffer = await resourceLoader(context).load(resource)
