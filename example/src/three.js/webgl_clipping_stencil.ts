...
@Entry
class webgl_clipping_stencil extends Panel {
  private gestureView?: GestureContainer;

  onShow() {
    navbar(context).setTitle("webgl_clipping_stencil");
  }
    ...
    this.gestureView.addChild(
      dangleView({
        onReady: (gl: DangleWebGLRenderingContext) => {
          ...
          let camera, scene, renderer, startTime, object, clock;
          let planes, planeHelpers, planeObjects, controls;
