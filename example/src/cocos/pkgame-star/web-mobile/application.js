System.register([], function (_export, _context) {
  ...
  function createApplication(_ref) {
    ...
    function start(_ref3) {
      ...
      return Promise.resolve().then(function () {
        ...
        console.warn("---------application.js\u52A0\u8F7Dcc\u5F15\u64CE\u5E93\u5B8C\u6210\u65F6\u95F4\uFF1A".concat(time - performance.timing.navigationStart, ",\u5F53\u524D\u65F6\u95F4:").concat(time));
  ...
  function onGameStarted(cc, settings) {
    ...
    cc.director.loadScene(launchScene, null, function () {
      cc.view.setDesignResolutionSize(750, 996, 4);
      console.log("Success to load scene: ".concat(launchScene));
      var time = new Date().getTime();
      console.warn("---------application.js\u52A0\u8F7D\u573A\u666F\u5B8C\u6210\u65F6\u95F4\uFF1A".concat(time - performance.timing.navigationStart, ",\u5F53\u524D\u65F6\u95F4:").concat(time));
    });
  }
